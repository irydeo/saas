...
class Ui_SaaSOptions(object):
    def setupUi(self, SaaSOptions):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 100, 681, 441))
        ...
        self.op_selected_filter_master = QtWidgets.QComboBox(self.seq)
        self.op_selected_filter_master.setGeometry(QtCore.QRect(340, 160, 121, 34))
        self.op_selected_filter_master.setObjectName("op_selected_filter_master")
        self.op_selected_filter_master.addItem("")
        self.op_selected_filter_master.addItem("")
        self.op_selected_filter_master.addItem("")
        self.op_selected_filter_master.addItem("")
        self.op_selected_filter_master.addItem("")
        ...
        self.op_calibrate_close_shutter.setGeometry(QtCore.QRect(310, 360, 181, 22))
        self.op_calibrate_close_shutter.setObjectName("op_calibrate_close_shutter")
        self.op_calibrate_use_filter_slave = QtWidgets.QCheckBox(self.seq)
        self.op_calibrate_use_filter_slave.setGeometry(QtCore.QRect(480, 130, 151, 22))
        self.op_calibrate_use_filter_slave.setObjectName("op_calibrate_use_filter_slave")
        self.op_calibrate_use_filter = QtWidgets.QCheckBox(self.seq)
        self.op_calibrate_use_filter.setGeometry(QtCore.QRect(310, 130, 241, 22))
        self.op_calibrate_use_filter.setObjectName("op_calibrate_use_filter")
        self.op_selected_filter_slave = QtWidgets.QComboBox(self.seq)
        self.op_selected_filter_slave.setGeometry(QtCore.QRect(510, 160, 121, 34))
        self.op_selected_filter_slave.setObjectName("op_selected_filter_slave")
        self.op_selected_filter_slave.addItem("")
        self.op_selected_filter_slave.addItem("")
        self.op_selected_filter_slave.addItem("")
        self.op_selected_filter_slave.addItem("")
        self.op_selected_filter_slave.addItem("")
        self.op_selected_filter_slave.addItem("")
        self.op_selected_filter_slave.addItem("")
        self.n_master_darks = QtWidgets.QSpinBox(self.seq)
        self.n_master_darks.setGeometry(QtCore.QRect(510, 210, 121, 22))
        self.n_master_darks.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.n_master_darks.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.n_master_darks.setMinimum(0)
        self.n_master_darks.setMaximum(15000)
        self.n_master_darks.setProperty("value", 10)
        self.n_master_darks.setObjectName("n_master_darks")
        self.label_51 = QtWidgets.QLabel(self.seq)
        self.label_51.setGeometry(QtCore.QRect(310, 240, 191, 21))
        self.label_51.setObjectName("label_51")
        self.label_52 = QtWidgets.QLabel(self.seq)
        self.label_52.setGeometry(QtCore.QRect(310, 210, 191, 21))
        self.label_52.setObjectName("label_52")
        self.n_master_bias = QtWidgets.QSpinBox(self.seq)
        self.n_master_bias.setGeometry(QtCore.QRect(510, 240, 121, 22))
        self.n_master_bias.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.n_master_bias.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.n_master_bias.setMinimum(0)
        self.n_master_bias.setMaximum(15000)
        self.n_master_bias.setProperty("value", 10)
        self.n_master_bias.setObjectName("n_master_bias")
        self.label_53 = QtWidgets.QLabel(self.seq)
        self.label_53.setGeometry(QtCore.QRect(310, 300, 191, 21))
        self.label_53.setObjectName("label_53")
        self.n_slave_bias = QtWidgets.QSpinBox(self.seq)
        self.n_slave_bias.setGeometry(QtCore.QRect(510, 300, 121, 22))
        self.n_slave_bias.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.n_slave_bias.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.n_slave_bias.setMinimum(0)
        self.n_slave_bias.setMaximum(15000)
        self.n_slave_bias.setProperty("value", 10)
        self.n_slave_bias.setObjectName("n_slave_bias")
        self.label_54 = QtWidgets.QLabel(self.seq)
        self.label_54.setGeometry(QtCore.QRect(310, 270, 191, 21))
        self.label_54.setObjectName("label_54")
        self.n_slave_darks = QtWidgets.QSpinBox(self.seq)
        self.n_slave_darks.setGeometry(QtCore.QRect(510, 270, 121, 22))
        self.n_slave_darks.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.n_slave_darks.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.n_slave_darks.setMinimum(0)
        self.n_slave_darks.setMaximum(15000)
        self.n_slave_darks.setProperty("value", 10)
        self.n_slave_darks.setObjectName("n_slave_darks")
    ...
    def retranslateUi(self, SaaSOptions):
        ...
        self.op_selected_filter_master.setItemText(0, _translate("SaaSOptions", "1"))
        self.op_selected_filter_master.setItemText(1, _translate("SaaSOptions", "2"))
        self.op_selected_filter_master.setItemText(2, _translate("SaaSOptions", "3"))
        self.op_selected_filter_master.setItemText(3, _translate("SaaSOptions", "4"))
        self.op_selected_filter_master.setItemText(4, _translate("SaaSOptions", "5"))
        self.op_selected_filter_master.setItemText(5, _translate("SaaSOptions", "6"))
        self.op_selected_filter_master.setItemText(6, _translate("SaaSOptions", "7"))
        self.op_calibrate_close_shutter.setText(_translate("SaaSOptions", "Close shuter at the end"))
        self.op_calibrate_use_filter_slave.setText(_translate("SaaSOptions", "Slave dark filter"))
        self.op_calibrate_use_filter.setText(_translate("SaaSOptions", "Master dark filter"))
        self.op_selected_filter_slave.setItemText(0, _translate("SaaSOptions", "1"))
        self.op_selected_filter_slave.setItemText(1, _translate("SaaSOptions", "2"))
        self.op_selected_filter_slave.setItemText(2, _translate("SaaSOptions", "3"))
        self.op_selected_filter_slave.setItemText(3, _translate("SaaSOptions", "4"))
        self.op_selected_filter_slave.setItemText(4, _translate("SaaSOptions", "5"))
        self.op_selected_filter_slave.setItemText(5, _translate("SaaSOptions", "6"))
        self.op_selected_filter_slave.setItemText(6, _translate("SaaSOptions", "7"))
        self.n_master_darks.setToolTip(_translate("SaaSOptions", "Sets number of frames needed to dither"))
        self.label_51.setText(_translate("SaaSOptions", "Number of master bias"))
        self.label_52.setText(_translate("SaaSOptions", "Number of master darks"))
        self.n_master_bias.setToolTip(_translate("SaaSOptions", "Sets number of frames needed to dither"))
        self.label_53.setText(_translate("SaaSOptions", "Number of slave bias"))
        self.n_slave_bias.setToolTip(_translate("SaaSOptions", "Sets number of frames needed to dither"))
        self.label_54.setText(_translate("SaaSOptions", "Number of slave darks"))
        self.n_slave_darks.setToolTip(_translate("SaaSOptions", "Sets number of frames needed to dither"))
